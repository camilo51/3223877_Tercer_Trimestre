...
export default function Tarjeta({ info }: TarjetaProps) {
  return (
    <div
      className="bg-white w-5/12 shadow-lg rounded p-5 mx-auto mt-5 text-center flex flex-col items-center justify-center relative overflow-hidden  transition-all duration-300
    "
    >
      ...
      <img
        className="w-36 aspect-square object-cover rounded-full mb-2 overflow-hidden p-2 border-2 border-indigo-600 text-center"
        src="./user.avif"
        alt={info.name}
      />
      <h1 className="text-center text-2xl uppercase font-bold mb-4 underline italic">
