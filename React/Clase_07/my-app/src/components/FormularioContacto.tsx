...
export default function FormularioContacto() {
    ...
    if (enviado) {
        return <h2 className="p-2 font-bold bg-green-200 text-green-800 inline-block m-5 rounded">¡Mensaje enviado! Gracias {datos.nombre}</h2>
    }
    return (
        <div className="w-2/12 space-y-1 ml-5 mt-5 bg-gray-200 p-2 rounded">
            ...
            />
            <button onClick={enviarFormulario} className="bg-green-400 w-full p-2 rounded uppercase font-bold cursor-pointer hover:bg-green-300 transition-all duration-150">Enviar</button>
        </div>
    )
}